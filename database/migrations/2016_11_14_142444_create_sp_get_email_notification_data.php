...
class CreateSpGetEmailNotificationData extends Migration {
     ...
     */
    public function up() {
        DB::unprepared("DROP PROCEDURE IF EXISTS getEmailNotificationData;
        CREATE PROCEDURE getEmailNotificationData(IN notificationId INT) 
        BEGIN
