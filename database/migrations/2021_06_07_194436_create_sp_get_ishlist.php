...
class CreateSpGetWishlist extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS getWishlist;
