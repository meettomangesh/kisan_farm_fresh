    ...
    // Initialize all the page-specific event listeners here.
        ...
        var fetchDataForEdit = function () {
            $('.portlet-body').on('click', '.edit-form-link', function () {
                ...
                var actionUrl = 'categories-master/' + cat_id + '/edit';
                $.ajax({
                    url: actionUrl,
                    cache: false,
                    dataType: "json",
                    ...
                    success: function (data)
                    {
                        ...
                        siteObjJs.validation.formValidateInit('#edit-category-master', handleAjaxRequest);
                    },
        ...
        var handleBootstrapMaxlength = function () {
            $('#create-category-master').find("textarea").maxlength({
                limitReachedClass: "label label-danger",
                alwaysShow: true,
                placement: 'bottom-right',
                threshold: 10
            });
            $('#edit-category-master').find("textarea").maxlength({
                limitReachedClass: "label label-danger",
                alwaysShow: true,
                placement: 'bottom-right',
                threshold: 10
