...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.basket.title_singular') }}
    </div>
        ...
        <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <input class="form-control {{ $errors->has('product_name') ? 'is-invalid' : '' }}" type="text" name="product_name" id="product_name" value="{{ old('product_name',  $basket->product_name) }}" maxlength="50" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <input class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}" type="text" name="sku" id="sku" value="{{ old('sku', $basket->sku) }}" maxlength="50" required>
                            @if($errors->has('sku'))
                            <div class="invalid-feedback">
                                {{ $errors->first('sku') }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <div class="input-group">
                                ...
                                <input class="form-control {{ $errors->has('selling_price') ? 'is-invalid' : '' }}" name="selling_price" id="selling_price" value="{{ old('selling_price', $basket->selling_price) }}" greaterThanZero="true" numberOnly="true" maxlength="10" autocomplete="off" required>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <div class="input-group">
                                ...
                                <input class="form-control {{ $errors->has('special_price') ? 'is-invalid' : '' }}" name="special_price" id="special_price" value="{{ old('special_price', $basket->special_price) }}" greaterThanZero="true" numberOnly="true" priceRangeValid="true" maxlength="10" autocomplete="off">
                            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            ...
                            <input class="form-control {{ $errors->has('special_price_start_date') ? 'is-invalid' : '' }}" type="date" name="special_price_start_date" id="special_price_start_date" min="{{ date('Y-m-d') }}" value="{{ old('special_price_start_date', $basket->special_price_start_date) }}" startDateValid="true">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            ...
                            <input class="form-control {{ $errors->has('special_price_end_date') ? 'is-invalid' : '' }}" type="date" name="special_price_end_date" id="special_price_end_date" min="{{ date('Y-m-d') }}" value="{{ old('special_price_end_date', $basket->special_price_end_date) }}" endDateValid="true">
                            <!-- span class="input-group-btn">
                                    <button class="btn default date-set" type="button" id="date-picker-btn"><i class="fa fa-calendar"></i></button>
                                </span>
                            </div -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <input class="form-control {{ $errors->has('min_quantity') ? 'is-invalid' : '' }}" name="min_quantity" id="min_quantity" value="{{ old('min_quantity', $basket->min_quantity) }}" greaterThanZero="true" numberOnly="true" maxlength="10" autocomplete="off" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <input class="form-control {{ $errors->has('max_quantity') ? 'is-invalid' : '' }}" name="max_quantity" id="max_quantity" value="{{ old('max_quantity', $basket->max_quantity) }}" greaterThanZero="true" numberOnly="true" quantityValid="true" maxlength="10" autocomplete="off" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <div class="radio-list">
                                <label class="radio-inline"><input type="radio" name="status" value="{{ old('status', '1') }}" {{ $basket->status == '1' ? 'checked' : '' }} required> {!! trans('cruds.basket.fields.active') !!}</label>
                                <label class="radio-inline"><input type="radio" name="status" value="{{ old('status', '0') }}" {{ $basket->status == '0' ? 'checked' : '' }} required> {!! trans('cruds.basket.fields.inactive') !!}</label>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table role="presentation" class="table table-striped table-bordered clearfix table-border-separate" id="image-preview-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">{{ trans('cruds.basket.fields.preview') }}</th>
                                            <th class="text-center">{{ trans('cruds.basket.fields.actions') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody class="files" id="dvPreview">
                                        <tr class="row-for-blank" id="blank-row-{{ $basket->id }}">
                                            <td class="text-center">1</td>
                                            <td class="text-center"><img src="{{ asset($basket->images) }}" alt="" width="60" height="60"></td>
                                            <td class="text-center"><span class="btn red" id="remove-btn" data-image-id="{{ $basket->id }}">Remove</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('productUnits') ? 'is-invalid' : '' }}" name="productUnits[]" id="productUnits" multiple required>
                    @foreach($productUnits as $id => $productUnit)
                        ...
                        <option value="{{ $productUnit->id }}" {{ (in_array($id, old('productUnits', [])) || $basket->productUnits->contains($productUnit->id)) ? 'selected' : '' }}><?php echo $productUnit->product->product_name.' ('.$productUnit->unit->unit.') ';?> </option>
                    @endforeach
                </select>
...
<script>
    jQuery(document).ready(function () {
        siteObjJs.admin.basketMerchantJs.init('edit-basket');
    });
</script>
@endsection