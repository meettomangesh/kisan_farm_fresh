...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['route' => ['admin.campaigns.store'], 'method' => 'post', 'class' => 'form-horizontal merchant-campaign-form', 'id' => 'create_campaign', 'msg' => 'Merchant Campaign added successfully.']) !!}
        @include('admin.campaigns.form', ['from'=>'create_campaign'])
