                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 float-right">
                            <div class="input-group">
                                ...
                                <input class="form-control {{ $errors->has('special_price') ? 'is-invalid' : '' }}" name="special_price" id="special_price" value="{{ old('special_price', '') }}" greaterThanZero = "true" numberOnly="true" maxlength="10" autocomplete="off">
                            </div>
